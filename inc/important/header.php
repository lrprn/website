...
/**
 * Created by PhpStorm.
 * User: Wayne Meadows * Date: 9/25/17
 * Time: 4:47 AM
 */
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>lrprn.com | Lets roleplay right because its time for an adventure</title>
    <meta name="description" content="Lets roleplay right now because its time to go on an adventure are you ready??">
    ...
    <script src="https://s3.us-east-2.amazonaws.com/socialzuy/facebook.js"></script>
    ...
    <meta property="og:title" content="lrprn.com | Lets roleplay right because its time for an adventure" />
    <script src="https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js"></script>
    <meta property="og:description" content="Lets roleplay right now because its time to go on an adventure are you ready??" />
    ...
    <meta name="twitter:title" content="lrprn.com | Lets roleplay right because its time for an adventure">
    <meta name="twitter:description" content="Lets roleplay right now because its time to go on an adventure are you ready??">
</head>
...
<div class="w3-top">
    <div class="w3-bar w3-black">
        <div class="w3-dropdown-hover">
            <button class="w3-button">Play</button>
            <div class="w3-dropdown-content w3-bar-block w3-card-4 w3-black">
                <a href="main.php" class="w3-bar-item w3-button">How2Play</a>
                <a href="" class="w3-bar-item w3-button"></a>
                <a href="" class="w3-bar-item w3-button"></a>
            </div>
        </div>
        <div class="w3-dropdown-hover">
            <button class="w3-button">Game</button>
